...
export const metadata: Metadata = {
  openGraph: {type:"website", siteName:"Mason Company", title:"Mason Company — Safer bathrooms for ageing parents", description:"Doctor-informed bathroom safety upgrades. Mason is currently available in Goa and Bangalore.", images:["/prerna/images/hero-install.jpg"]},
